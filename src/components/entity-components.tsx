...
type EntityHeaderProps = {
    ...
    disabled?: boolean;
    isCreating?: boolean;
} & (    // extending it further (cases when button perfrom an action or button is a link or when there is no button at all)
...
interface EntityListProps<T> {    // T means generic
    items: T[];
